...
def plot_kinetic(subject_kinetic_case1, subject_spt_case1, color1,
    ...
    for trace in ['mean', 'control']:
        ...
        list_ylim = [(-30, 60), (-10, 70), (-30, 30),
                     (-1.2, 1.2), (-0.8, 0.8), (-0.6, 1.6),
                     (-2.0, 2.0), (-2.0, 2.0), (-4.0, 4.0),
                     (0, 150), (-30, 30), (-20, 20)]

        list_ytick = [[-30, -5, 20, 45, 60], [-10, 10, 30, 50, 70], [-30, -15, 0, 15, 30],
                      [-1.2, -0.6, 0, 0.6, 1.2], [-0.8, -0.4, 0, 0.4, 0.8], [-0.6, 0, 0.6, 1.2, 1.6],
                      [-2.0, -1.0, 0, 1.0, 2.0], [-2.0, -1.0, 0, 1.0, 2.0], [-4.0, -2.0, 0, 2.0, 4.0],
        ...
        list_yticklabel = [["-30", "Ext", "deg", "Flex", "60"],
                           ...
                           ["-1.2", "Ext", "N-m/kg", "Flex", "1.2"],
                           ["-0.8", "Ext", "N-m/kg", "Flex", "0.8"],
                           ["-0.6", "Plant", "N-m/kg", "Dorsi", "1.6"],
                           ["-2.0", "Abs", "Watt", "Gen", "2.0"],
                           ["-2.0", "Abs", "Watt", "Gen", "2.0"],
                           ["-4.0", "Abs", "Watt", "Gen", "4.0"],
                           ["0", "50", "BW %", "120", "150"],
                           ["-30", "-15", "BW %", "15", "30"],
                           ["-20", "-10", "BW %", "10", "20"]]
